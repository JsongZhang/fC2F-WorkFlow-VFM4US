...
def get_arguments():
    ...
    parser.add_argument('-load_path', type=str, default='/SZU_DATA/us-vfm/downstream_task/seg/code/run/run_9/use_sm_deeplabv3plus_best.pth')
...
def main(args):
    ...
    net = smp.DeepLabV3Plus(encoder_name="resnet18", encoder_weights=None, in_channels=3, classes=1)
